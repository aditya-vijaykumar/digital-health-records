...
public class PViewHealthRecord {
  private HealthRecord record;
  private String doctorName;
  private String doctorLicense;

  public PViewHealthRecord(HealthRecord record, String doctorName, String doctorLicense) {
    this.record = record;
  ...
  public VBox display() {
    ...
    Text subtitle2 = new Text("Doctor License No : " + doctorLicense);
